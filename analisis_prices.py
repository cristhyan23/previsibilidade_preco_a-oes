...
#função responsavel por capturar as ações levantar o ultimo preço e salvar no arquivo    
    ...
    def add_diferences_prediciton_add_last_price(self):
        ...
        for stock in stock_info:
            ...
            price_diferences_1 = (prediction_data_1 / last_price - 1) 
            ...
            price_diferences_2 = (prediction_data_2 / prediction_data_1 - 1) 
            ...
            price_diferences_3 = (prediction_data_3 / prediction_data_2 - 1) 
            ...
            price_diferences_4 = (prediction_data_4 / prediction_data_3 - 1) 
            ...
            price_diferences_5 = (prediction_data_5 / prediction_data_4 - 1) 
            ...
            price_diferences_6 = (prediction_data_6 / prediction_data_5 - 1) 
            ...
            price_diferences_7 = (prediction_data_7 / prediction_data_6 - 1) 
